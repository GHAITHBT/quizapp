...
<div style={{backgroundColor:"#177985",height:"120px"}}><center><h3  style={{color:"white",paddingTop:"25px"}}>Food Safety Culture : Auto-évaluation
 ...
 "url('images/cheese2.jpg')",
    ...
    <div class="card text-white bg-dark mb-3 info_box" style={{width:"60%",cursor:"pointer"}}>
        <center ><h4 style={{color:"white"}}>Quel est votre fonction dans la societe</h4></center>
  <div class="card-body">
...
<br></br></td><td>
        ...
        <td>
         ...
         <tr>
         <td>
          <input type="radio" value="Other" name="gender" onChange={(e) =>BT(localStorage.setItem('Poste',"Magasinier"))}/> Magasinier<br></br></td></tr>
          </table>
